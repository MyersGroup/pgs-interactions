...
phen_res_cov_train <- fread(paste0("../results/05-new-app/residuals-covars/", phen, "/", phen, "-", train_sp, "-resid-covars.tab"),
                            data.table = FALSE)
...
pgs_full_mc <- fread(paste0("../results/05-new-app/mean-corrected/", phen,
...
## save summary stats
sink(paste0("../results/05-new-app/ancestry-interactions/", phen, "/r2_", r2, "-kb_", kb, "/",
...
## export
fwrite(resid_df_all,
       file = paste0("../results/05-new-app/ancestry-interactions/", phen, "/r2_", r2, "-kb_", kb, "/",
...
for (chr in 1:22) {
    ...
    pgs_loco_mc <- fread(paste0("../results/05-new-app/mean-corrected/", phen,
